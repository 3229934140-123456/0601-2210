...
const RouteDetailPage = () => {
  ...
  const handleStartGuide = () => {
    const currentNode = currentIndex >= 0 ? route.nodes[currentIndex] : route.nodes[0];
    if (currentNode) {
    ...
    <View className={styles.page}>
      ...
      <View className={styles.content}>
        <View className={styles.statsCard}>
          ...
          <View className={styles.statItem}>
            <Text className={styles.num}>{route.exhibitCount}</Text>
            <Text className={styles.label}>展品数量</Text>
          </View>
          <View className={styles.statItem}>
            <Text className={styles.num}>{completedCount}/{route.exhibitCount}</Text>
              ...
              return (
                ...
                >
                  ...
                  <View className={styles.nodeMeta}>
                    <Text>⏱ 约 {formatDuration(node.estimatedTime)}</Text>
                  ...
                  <View className={styles.nodeAction}>
                    <View
                      ...
                      onClick={() => handleExhibitClick(node.exhibitId)}
                    >
